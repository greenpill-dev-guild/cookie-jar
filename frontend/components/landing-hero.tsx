    ...
    <>
        ...
        <header className="page-header">
          <div className="section-container flex items-center justify-between">
            <Link href="/" className="flex items-center gap-3">
              ...
              <span className="text-3xl md:text-4xl font-bold text-[#4a3520]">Cookie Jar V3</span>
            </Link>
            ...
            <nav className="hidden md:flex items-center gap-8">
              <Link href="/jars" className="text-lg font-medium text-[#4a3520] hover:text-primary transition-colors">
                EXPLORE
              </Link>
              <Link href="/create" className="text-lg font-medium text-[#4a3520] hover:text-primary transition-colors">
                CREATE
              </Link>
              <Link href="/docs" className="text-lg font-medium text-[#4a3520] hover:text-primary transition-colors">
                DOCS
              </Link>
              <CustomConnectButton />
            </nav>
          ...
          <div className="section-container py-16 md:py-24 w-full">
            <div className="hero-content">
              <h1 className="mega-text mb-8">
                SHARE <span className="text-primary">RESOURCES</span> WITH
                <br />
                COOKIE JARS
              </h1>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6">
                <AnimatedButton
                  text={isConnected ? "EXPLORE JARS" : "CONNECT & EXPLORE"}
      ...
      <div className="page-section cream-bg">
        <div className="section-container">
          <h2 className="text-center mb-16 text-[#4a3520]">HOW IT WORKS</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="flex flex-col items-center text-center">
              <div className="w-20 h-20 rounded-full bg-primary/10 flex items-center justify-center mb-6">
                <span className="text-3xl font-bold text-primary">1</span>
              </div>
              <h3 className="mb-4 text-[#4a3520]">Create a Jar</h3>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="mb-4 text-[#4a3520]">Deposit Funds</h3>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="mb-4 text-[#4a3520]">Manage Withdrawals</h3>
              <p className="text-xl text-[#4a3520]">
