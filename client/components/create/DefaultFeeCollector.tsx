    ...
    <div className="space-y-6">
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground">
          As the current fee collector, you can transfer this role to another
          address.
        </p>
      ...
      <div className="bg-muted/50 p-4 rounded-lg">
        ...
        <p className="text-sm text-muted-foreground">
          The fee collector receives a percentage of all transactions processed
          through this CookieJar. Transferring this role will give another
          address these privileges.
        </p>
      </div>
    </div>
  );
