      ...
      try {
        ...
        for (const func of v2Functions) {
          try {
            ...
            const functionSelector = func.split('(')[0];
            ...
            const bytecode = await publicClient.getCode({ address: jarAddress });
            ...
            if (bytecode && bytecode.length > 20000) { // Rough size threshold
              v2FunctionCount++;
            }
          } catch (e) {
