 ...
 * ```
 */
export function parseJarMetadata(rawMetadata: string | undefined): ParsedJarMetadata {
 ...
 */
export function createMetadataJson(metadata: Omit<ParsedJarMetadata, 'isV2Format'>): string {
