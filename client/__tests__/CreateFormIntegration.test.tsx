...
const CreateFormLogic = () => {
	...
	return (
		<div data-testid="create-form">
			...
			/>
			{errors.jarName && (
				<div data-testid="jar-name-error">{errors.jarName}</div>
			)}
			...
			/>
			{errors.imageUrl && (
				<div data-testid="image-url-error">{errors.imageUrl}</div>
			)}
			...
			/>
			{errors.externalLink && (
				<div data-testid="external-link-error">{errors.externalLink}</div>
			)}
			...
			/>
			{errors.metadata && (
				<div data-testid="description-error">{errors.metadata}</div>
			)}
			...
			{enableCustomFee && (
				<>
					...
					/>
					{errors.customFee && (
						<div data-testid="custom-fee-error">{errors.customFee}</div>
					)}
				</>
			)}
