...
test.describe('🔗 Anvil Integration Tests', () => {
  ...
  test('Navigate to create jar page and verify form loads', async ({ page }) => {
    ...
    const currencySelector = page.locator('[data-testid="currency-selector"], [role="combobox"]')
  ...
  test('Verify chain configuration and network detection', async ({ page }) => {
    ...
    const networkIndicators = page.locator('text=Anvil Local, text=31337, text=Local')
